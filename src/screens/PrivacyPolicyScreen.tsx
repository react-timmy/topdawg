...
import {
  APP_NAME, LAST_UPDATED, PRIVACY_VERSION,
  PRIVACY_POLICY_URL, PRIVACY_POLICY_SECTIONS,
  ...
  return (
    <View style={styles.root}>
      ...
      <View style={[styles.topBar, { paddingTop: insets.top + 6 }]}>
        ...
        <Pressable onPress={() => Linking.openURL(PRIVACY_POLICY_URL).catch(() => {})} hitSlop={12} style={styles.iconBtn}>
      ...
      >
        ...
        <Text style={styles.meta}>Version {PRIVACY_VERSION} · Last updated {LAST_UPDATED}</Text>
        ...
        <Pressable onPress={() => Linking.openURL(PRIVACY_POLICY_URL).catch(() => {})} style={styles.link}>
