...
import { View, Text, StyleSheet, FlatList, ActivityIndicator, RefreshControl, Pressable, Alert, Modal } from "react-native";
...
import { Tv, ScanLine, Users, Plus, LogIn } from "lucide-react-native";
...
export function TVScreen() {
  ...
  const handleCreateWatchParty = async () => {
    ...
    if (sortedItems.length === 0) {
      Alert.alert('Notice', 'Add some TV shows to your library first!');
      return;
    }

    // Use the most recently played TV show, or the first one
