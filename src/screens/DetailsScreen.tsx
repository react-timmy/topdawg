...
const styles = StyleSheet.create({
  ...
  movieColor: { color: '#f59e0b' },
  tvColor: { color: '#60a5fa' },
  ...
  genrePillText: { fontSize: 12, color: '#a1a1aa', fontWeight: '600' },
  ...
  seasonChipText: { color: '#71717a', fontSize: 13, fontWeight: '600' },
  seasonChipTextActive: { color: '#60a5fa', fontWeight: '800' },
  ...
  episodeMeta: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  episodeMetaText: { fontSize: 11, color: '#71717a', fontWeight: '500' },
  episodeOverview: {
    fontSize: 12,
    color: '#71717a',
    lineHeight: 17,
